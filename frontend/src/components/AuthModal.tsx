...
export default function AuthModal() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (isLoginTab) {
            ...
            success = await register(name, email, password, phone, isOwner ? "restaurant_owner" : "user");
        }
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6 flex-1 flex flex-col justify-between">
                    <div>
                        <div className="text-center mb-8">
                            <h2 className="font-display text-2xl font-medium text-primary tracking-tight">Welcome to DineFlow</h2>
