...
export default function BookingWidget({
    ...
    const visibleSlots = slotsAvailability.filter((slotInfo: any) => {
                ...
                <div className="space-y-2 pt-2">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        {loadingSlots ? (
                            ...
                            <p className="col-span-3 text-xs text-black/55 italic py-3">No reservation times are available for this date.</p>
                        ) : (
